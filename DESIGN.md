...
colors:
  ...
  graphite-main: "#181818"
  graphite-sidebar: "#141414"
  graphite-panel: "oklch(0.18 0 0)"
  graphite-raised: "#2d2d2d"
  graphite-control: "#212121"
  graphite-selected: "oklch(0.269 0 0)"
  graphite-menu: "#2b2b2b"
  graphite-menu-hover: "#414141"
  ...
  state-attention: "#339cff"
  state-danger: "oklch(0.704 0.191 22.216)"
  state-warning: "#fa423d"
typography:
  display:
